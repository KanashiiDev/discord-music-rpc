...
(function (global, factory) {
	...
	const getDom = query => {
		...
		if (isHtmlString(query)) {
			...
			const doc = parser.parseFromString(query.trim(), 'text/html');
	...
	class TomSelect extends MicroPlugin(MicroEvent) {
	   ...
	   */
		destroy() {
			...
			const parser = new DOMParser();
			const doc = parser.parseFromString(revertSettings.innerHTML, 'text/html');
			self.input.replaceChildren(...Array.from(doc.body.childNodes));
